...
또한, 특정한 시점 $t\gt0$에 대하여, 시각 $t$까지 사건이 발생한 횟수를 $N_t$라고 하면

![]({{site.url}}\images\2024-03-15-mm1_queue\Ni.png){: .img-80-center}

모든 $t\gt0$에 대하여 $N_t$는 확률변수입니다.
따라서 arrival process는 확률변수 $N_t$들의 집합

$$\{N_t:t\gt0,\cdots\}\tag{1.4}$$

으로도 표현될 수 있습니다.

다시 말해, arrival process는 확률과정으로 이해할 수 있는데 (1.2), (1.3), (1.4)의 서로 다른 세 방식의 확률과정으로 해석될 수 있는 것입니다.
