...
(6)에서 평균적으로 $\frac1\lambda$만큼의 시간간격마다 arrival이 발생한다고 했었습니다.
...
$$
P(N=n)=\frac{\lambda^n}{n!}e^{-\lambda}\quad(n=0,1,2,\cdots)\tag{10}
$$
...
$$p_k(t)=P\left(K_t=k\right)\tag{11}$$
...
그런 의미에서 wikipedia에서는 M/M/1 queue model이 다음과 같은 (triadiagonal) transition matrix로 표현할 수 있다고 서술하고 있습니다.
...
<div style="text-align : center; padding: 50px 1px 50px 1px;">
    <img src="{{site.url}}\images\2023-03-15-mm1_queue\transition_matrix.png" alt="transition_matrix" width="300"/>
</div>
