...
1.5에서 평균적으로 $\frac1\lambda$만큼의 시간간격마다 arrival이 발생한다고 했었습니다.
...
$m$이 충분히 크면, 구간 $\left[\left.t, t+\frac1m\right)\right.$동안 arrival 또는 departure이 두 번 이상 발생하지 않았다고 가정할 수 있습니다.
