...
![]({{site.url}}\images\2024-03-15-mm1_queue\queue_with_one_server.png){: .img-80-center}
...
![]({{site.url}}\images\2024-03-15-mm1_queue\mm1_queueing_node.png){: .img-80-center}

# 2.3 queue length $N_t$

시각 $t$에 따라서 queue의 상태는 변합니다.
예를 들어, 대기열의 길이(queue length)는 실시간으로 변합니다.
시각 $t$에서의 대기열의 길이를 $N_t$라고 하면, 확률변수 $N_t$의 분포의 시간에 따른 추이를 생각해볼 수 있습니다.

![]({{site.url}}\images\2024-03-15-mm1_queue\transition_unit_time.png){: .img-80-center}
