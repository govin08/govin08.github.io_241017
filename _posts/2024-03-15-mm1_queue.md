...
$$p_n(t)=P\left(N_t=n\right)$$

라고 하면,

$$p_0(t) + p_1(t) + p_2(t) + p_3(t) + \cdots = 1$$
...
p_2\left(t+\frac1m\right)&=\frac\lambda mp_1(t)+\left(1-\frac\lambda m\right)\left(1-\frac\mu m\right)p_2(t)+\frac\mu mp_3(t)\\
\end{align*}
$$
